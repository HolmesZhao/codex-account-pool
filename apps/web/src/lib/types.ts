...
export interface Account { id: string; email: string; alias: string; enabled: boolean; status: string; generation: number; credentialMode: "legacy" | "at-only"; usage?: AccountUsage | null; updatedAt?: string }
